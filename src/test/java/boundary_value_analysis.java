...
public class boundary_value_analysis {
    ...
    public void TC3_6letters() {
        assert demo.method(randomString.generate(6));
    }

    @Test
    public void TC4_12letters() {
        assert demo.method(randomString.generate(12));
    }

    @Test
    public void TC5_19letters() {
        assert demo.method(randomString.generate(19));
    }
    ...
    public void TC8_4letters_lowercase() {
        assertFalse(demo.method(randomString.generateLower(4)));
    }
    ...
    public void TC10_6letters_lowercase() {
        assert demo.method(randomString.generateLower(6));
        assert captureConsoleRule.getOutput().contains("Lowercase");
    }

    @Test
    public void TC11_12letters_lowercase() {
        assert demo.method(randomString.generateLower(12));
        assert captureConsoleRule.getOutput().contains("Lowercase");
    }

    @Test
    public void TC12_19letters_lowercase() {
        assert demo.method(randomString.generateLower(19));
        assert captureConsoleRule.getOutput().contains("Lowercase");
    }
    ...
    public void TC14_21letters_lowercase() {
        assertFalse(demo.method(randomString.generateLower(21)));
    }

    @Test
    public void TC15_4letters_uppercase() {
        assertFalse(demo.method(randomString.generateUpper(4)));
    }
    ...
    public void TC17_6letters_uppercase() {
        assert demo.method(randomString.generateUpper(6));
        assert captureConsoleRule.getOutput().contains("Uppercase");
    }

    @Test
    public void TC18_12letters_uppercase() {
        assert demo.method(randomString.generateUpper(12));
        assert captureConsoleRule.getOutput().contains("Uppercase");
    }

    @Test
    public void TC19_19letters_uppercase() {
        assert demo.method(randomString.generateUpper(19));
        assert captureConsoleRule.getOutput().contains("Uppercase");
    }
    ...
    public void TC21_21letters_uppercase() {
        assertFalse(demo.method(randomString.generateUpper(21)));
    }
